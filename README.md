# NYtaxi Readme
This is a readme for the project predicting New York Cities Taxi fare on Kaggle.
...
- NYTaxi_data_cleaning_gcp.ipynb: this file runs on Google Cloud that cleans the raw data from Kaggle and 
